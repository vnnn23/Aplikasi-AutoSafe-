...
<body class="body">
  ...
  <img src="{{ asset('image/profil.png') }}" alt="Profil" class="logo-icon" style="width:48px;height:48px;object-fit:cover;border-radius:50%;" />
    ...
    <div class="hero-text">
      ...
      <a href="{{ url('/layanan') }}" aria-label="Pesan Penitipan Kendaraan Sekarang" id="orderBtn" class="order-button">
  ...
  <main class="main-content">
    ...
    <section aria-label="Layanan Kami" class="section-service">
      <div class="service-header">
        ...
        <a href="layanan" class="service-link">Lainnya ></a>
      </div>
      <ul class="service-list">
        <!-- Motor service -->
        <li>
          <a href="{{ url('/layanan?layanan=motor-harian') }}" class="service-item" tabindex="0" role="button" aria-label="Penitipan Motor - Harian, Mulai dari Rp 25.000">
        ...
        <!-- Mobil service -->
        <li>
          <a href="{{ url('/layanan?layanan=mobil-harian') }}" class="service-item" tabindex="0" role="button" aria-label="Penitipan Mobil - Harian, Mulai dari Rp 45.000">
...
<nav class="bottom-nav">
  ...
  <a href="/infoakun" class="nav-item">
